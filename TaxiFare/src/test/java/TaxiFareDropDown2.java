 ...
 */
public class TaxiFareDropDown2 extends Base{
    @Test
      ...
      //  displayText(listCountry);
        ...
        for (int y = 0; y < listCountry.size() - 1; y++) {     // y = size of counrty (listCountry.size())
            ...
            //   new Select(driver.findElement(By.id("countrySelect"))).selectByVisibleText(listMenu.get(y));
                ...
                //  if (y == 0) {
                for (int k = 1; k < 2; k++) {     //  k is the list of  city for (int k = 1; k < listOfCity.size(); k++)
                    ...
                    FileUtils.copyFile(scrFile, new File("/Users/shamimchy/IdeaProjects/NewTestForTaxiFare/TaxiFare/ScreenShot/screenshot_" + (y + 1) + "_" + k + "_a.png"));
                    Thread.sleep(2000);
...
//                                      System.out.println("alert is not present");
                                  ...
                                  FileUtils.copyFile(scrFile, new File("/Users/shamimchy/IdeaProjects/NewTestForTaxiFare/TaxiFare/ScreenShot/screenshot_" + (y + 1) + "_" + c + "_a.png"));
